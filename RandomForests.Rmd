...
```{r}
p1 = ggplot(train, aes(x = Impulsive, fill = Nicotine)) + geom_bar(position = "fill")
p2 = ggplot(train, aes(x = Ascore, fill = Nicotine)) + geom_bar(position = "fill")
p3 = ggplot(train, aes(x = Cscore, fill = Nicotine)) + geom_bar(position = "fill")
